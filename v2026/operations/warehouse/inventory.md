...
|FarmBot      |Versions |
|-------------|---------|
|Genesis      |`v1.2`, `v1.3`, `v1.4`, `v1.5`, `v1.6`, `v1.7`, `v1.8`
|Genesis (XL) |`v1.4`, `v1.5`, `v1.6`, `v1.7`, `v1.8`
|Express      |`v1.0`, `v1.1`
|Express (XL) |`v1.0`, `v1.1`

In the warehouse, this organization manifests in the form of storage racks dedicated to each FarmBot version's replacement parts, as well as areas used for the palletized full kits of the newest version of a FarmBot.
